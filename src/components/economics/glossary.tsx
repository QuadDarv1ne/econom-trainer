...
interface GlossaryTerm {
  term: string
  definition: string
  category: 'Микроэкономика' | 'Макроэкономика' | 'Финансы' | 'Международная экономика'
  formula?: string
}
...
const glossaryData: GlossaryTerm[] = [
  ...
  },
  {
    ...
    category: 'Международная экономика',
  },
  {
...
const categories = ['Все', 'Микроэкономика', 'Макроэкономика', 'Финансы', 'Международная экономика'] as const
...
export function Glossary() {
  ...
  const getCategoryColor = (cat: string) => {
    switch (cat) {
      case 'Микроэкономика': return 'default'
      case 'Макроэкономика': return 'secondary'
      case 'Финансы': return 'outline'
      case 'Международная экономика': return 'destructive'
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {glossaryData.length} ключевых терминов по экономике с определениями и формулами. 
        ...
        <CardContent className="space-y-4">
          ...
          <div className="text-sm text-muted-foreground">
            Найдено: {filteredTerms.length} {filteredTerms.length === 1 ? 'термин' : 'терминов'}
          </div>
        </CardContent>
      </Card>
