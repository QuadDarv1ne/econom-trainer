...
1. Добавить unit-тесты для React компонентов (калькуляторы, графики)
2. Расширить E2E тесты для дополнительных сценариев (тёмная тема, все модули)
3. Добавить больше вопросов в квизы (сейчас 45, можно расширить до 100+)
4. Рассмотреть добавление новых модулей (экономические кризисы, монетарная политика)
5. Оптимизация производительности (ленивая загрузка модулей, code splitting)
